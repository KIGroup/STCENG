...
/**dddd
 * $trdnsidddtion service provides a consistent interface to trigger CSS 3 transitions and to be informed when they complete.
...
angular.module("template/datepicker/popup.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/datepicker/popup.html",
    ...
    "	<li ng-transclude></li>\n" +
    "	<li class=\"divider\" ng-hide=\"true\"></li>\n" +
    "	<li style=\"padding: 9px;\">\n" +
    "		<span class=\"btn-group\" ng-hide=\"true\">\n" +
    "			<button class=\"btn btn-small btn-inverse\" ng-click=\"today()\">Today</button>\n" +
    "			<button class=\"btn btn-small btn-info\" ng-click=\"showWeeks = ! showWeeks\" ng-class=\"{active: showWeeks}\">Weeks</button>\n" +
    "			<button class=\"btn btn-small btn-danger\" ng-click=\"clear()\">Clear</button>\n" +
    "		</span>\n" +
    "		<button class=\"close pull-right\" ng-click=\"isOpen = false\">&times;</button>\n" +
    "	</li>\n" +
    "</ul>");
}]);
...
angular.module("template/dialog/message.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/dialog/message.html",
    ...
    "	<h4>{{ title }}</h4>\n" +
    "</div>\n" +
    "<div class=\"modal-body\" ng-bind-html-unsafe=\"message\" style=\"text-align: justify;\">\n" +
    "</div>\n" +
...
angular.module("template/rating/rating.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/rating/rating.html",
    ...
    "	<i ng-repeat=\"number in range\" ng-mouseenter=\"enter(number)\" ng-click=\"rate(number)\" ng-class=\"{'icon-star icon-large': number <= val, 'icon-star-empty icon-large': number > val}\" style=\"padding-right: 5px;\"></i>\n" +
    "</span>");
}]);
